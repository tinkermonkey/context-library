...
class TestQueryRetiredPersonLinks:
    ...
    def test_active_person_links_not_retired(self, store: DocumentStore) -> None:
        ...
        store.write_entity_links([EntityLink(person_hash, other_hash, ENTITY_LINK_TYPE_PERSON_APPEARANCE, 1.0)])
    ...
    def test_multiple_retired_person_links(self, store: DocumentStore) -> None:
        ...
        store.write_entity_links([
            EntityLink(person_hash1, other_hash, ENTITY_LINK_TYPE_PERSON_APPEARANCE, 1.0),
            EntityLink(person_hash2, other_hash, ENTITY_LINK_TYPE_PERSON_APPEARANCE, 1.0),
        ])
    ...
    def test_non_person_domain_chunks_not_affected(self, store: DocumentStore) -> None:
        ...
        store.write_entity_links([
            EntityLink(person_hash, _make_hash("target1"), ENTITY_LINK_TYPE_PERSON_APPEARANCE, 1.0),
            EntityLink(msg_hash, _make_hash("target2"), ENTITY_LINK_TYPE_PERSON_APPEARANCE, 1.0),
        ])
